...
function rpsGame(yourChoice) {
  ...
  results = decideWinner(humanChoice, botChoice); // 1,0.5,0
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
  ...
  humanDiv.innerHTML = `<img src='${imagesDatabase[humanImageChoice]}' style="width:80%; box-shadow: 0px 10px 50px rgba(37,50,233,1);">`;
  messageDiv.innerHTML = `<h1 style='color:${finalMessage["color"]};font-size:60px;padding:30px;'>${finalMessage["message"]}</h1>`;
  botDiv.innerHTML = `<img src='${imagesDatabase[botImageChoice]}' style="width:80%; box-shadow: 0px 10px 50px rgba(243,38,24,1);">`;
